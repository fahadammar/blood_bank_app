...
class BloodBankSignIn extends StatefulWidget {
  @override
  _BloodBankSignInState createState() => _BloodBankSignInState();
}

class _BloodBankSignInState extends State<BloodBankSignIn> {
  double _height;
  double _width;
  double _pixelRatio;
  bool _large;
