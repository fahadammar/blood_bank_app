...
class RecipientSignIn extends StatefulWidget {
  @override
  _RecipientSignInState createState() => _RecipientSignInState();
}

class _RecipientSignInState extends State<RecipientSignIn> {
  double _height;
  double _width;
  double _pixelRatio;
  bool _large;
  ...
  // Sign Into your admin account text
  Widget signInTextRow() {
    return Container(
      ...
      child: Row(
        children: <Widget>[
          Text(
            "Sign in to your recipient account",
            style: TextStyle(
